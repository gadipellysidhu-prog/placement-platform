...
export default function ForbiddenPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-background p-8 text-center">
      ...
      <h1 className="text-4xl font-bold text-foreground">You don&apos;t have permission</h1>
      <p className="max-w-sm text-sm text-muted-foreground">
        You do not have the required role to access this resource. Contact your placement officer if
